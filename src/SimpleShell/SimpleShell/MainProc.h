...
@property (strong) NSNumber *quit;
@property (strong) NSNumber *qwin;
...
@property (strong) NSNumber *ansi;
@property (strong) NSNumber *ansd;
...
@property (strong) NSMutableAttributedString *part;
...
@property (assign) VTerm *term;
@property (assign) VTermScreen *vtsc;
