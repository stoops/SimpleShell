...
@property (strong) NSNumber *lidx;
@property (strong) NSNumber *lmod;
...
@property (strong) NSButton    *srcp;
@property (strong) NSButton    *srcn;
@property (strong) NSButton    *srcd;
